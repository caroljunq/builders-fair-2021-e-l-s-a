...
def read_device_data(device_name, client_id, date):
    ...
    s3.put_object(Body=csv_data, Bucket='elsa-datalake', Key=f'raw-data/client_id={client_id}/device_name={device_name}/year={year}/month={month}/day={day}/{client_id}_{device_name}_{date}.csv')

    
def get_device_list():
    
    table_name = 'devices-metadata'
